...
export function AuthModal({ isOpen, onClose, onLogin }: AuthModalProps) {
  ...
  const handleLogin = () => {
    ...
    toast({
      title: "로그인 성공",
      description: `${userType === "worker" ? "구직자" : "구인자"}로 로그인되었습니다.`,
    })
    onClose()
  }
  ...
  const handleSignup = () => {
    ...
    toast({
      title: "회원가입 성공",
      description: "환영합니다! 이메일 인증을 완료해주세요.",
    })
    onClose()
  }
      ...
      <DialogContent className="max-w-md mx-auto">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          ...
          <TabsContent value="login" className="space-y-4">
            ...
            <div className="space-y-2">
              <Label>사용자 유형</Label>
              <Select value={userType} onValueChange={(value: "worker" | "employer") => setUserType(value)}>
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value="worker">구직자 (일자리를 찾는 사람)</SelectItem>
                  <SelectItem value="employer">구인자 (사람을 구하는 사람)</SelectItem>
                </SelectContent>
              </Select>
            </div>
